...
- [NOV+DEC 2022](#novdec-2022)
    - [Docker ARG vs ENV · vsupalov.com](#docker-arg-vs-env-·-vsupalovcom)
    - [ec](#ec)
    - [python - What is the difference between is None and == None - Stack Overflow](#python---what-is-the-difference-between-is-none-and--none---stack-overflow)
    - [networking - What does it mean to have a subnet mask /32? - Super User](#networking---what-does-it-mean-to-have-a-subnet-mask-32---super-user)
    - [Writing good performance self reviews - by Andrew Huth](#writing-good-performance-self-reviews---by-andrew-huth)
    - [Cut Command in Linux](#cut-command-in-linux)
    - [future proof](#future-proof)
    - [Pub/Sub gains topic retention feature](#pubsub-gains-topic-retention-feature)
    - [nonlocal](#nonlocal)
    - [scowled](#scowled)
    - [Putin, Isolated and Distrustful, Leans on Handful of Hard-Line Advisers - WSJ](#putin-isolated-and-distrustful-leans-on-handful-of-hard-line-advisers---wsj)
    - [What's the difference between Python's subprocess.call and subprocess.run - Stack Overflow](#whats-the-difference-between-pythons-subprocesscall-and-subprocessrun---stack-overflow)
    - [Philip Pullman: ‘I had to grow up before I could cope with Middlemarch’](#philip-pullman-i-had-to-grow-up-before-i-could-cope-with-middlemarch)
    - [Bash: grep with LookBehind and LookAhead to isolate desired text](#bash-grep-with-lookbehind-and-lookahead-to-isolate-desired-text)
    - [What is the XY problem? - Meta Stack Exchange](#what-is-the-xy-problem---meta-stack-exchange)
    - [bash - How to reload .bashrc settings without logging out and back in again? - Stack Overflow](#bash---how-to-reload-bashrc-settings-without-logging-out-and-back-in-again---stack-overflow)
    - [Jak jednoduše a rychle odmrazit mrazák během pár minut](#jak-jednoduše-a-rychle-odmrazit-mrazák-během-pár-minut)
