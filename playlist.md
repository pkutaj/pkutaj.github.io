  ...
  - [7.16. Is 'jobs' a four-letter word? — Benn Stancil](#716-is-jobs-a-four-letter-word-benn-stancil)
  ...
  - [7.22. Brute Intelligence — Benn Stancil](#722-brute-intelligence-benn-stancil)
  - [7.23. How Swimming Completely Changes The Human Body](#723-how-swimming-completely-changes-the-human-body)
  - [7.24. Architecture, AI agents, and product empathy with Robert C. Martin](#724-architecture-ai-agents-and-product-empathy-with-robert-c-martin)
...
- [8. AUG-2026](#8-aug-2026)
  ...
  - [8.8. How To Be Naturally Charismatic (Even If You're Quiet)](#88-how-to-be-naturally-charismatic-even-if-youre-quiet)
...
- [9. SEP-2026](#9-sep-2026)
  ...
  - [9.12. Anthropic Just Threatened to Kill Billions of People. This Is Not Okay. — Cal Newport](#912-anthropic-just-threatened-to-kill-billions-of-people-this-is-not-okay-cal-newport)
...
* <https://www.youtube.com/watch?v=-Fs2H-pPJMQ>
 * <one_line_summary>
...
### 6.22. Your agent will be your undoing — Benn Stancil
* <https://benn.substack.com/p/get-out-of-the-token-path>
 * Argues startups should stay out of the token path — labs co-evolving general harnesses with models will eat specialized agents

### 6.23. The Soul of a New Machine — Tracy Kidder
* <https://www.amazon.com/Machine-Tracy-Kidder-1-Oct-1986-Paperback/dp/B012HV4OAQ>
 * Classic 1981 book on building a minicomputer at Data General — recommended by Oxide CTO Bryan Cantrill on Pragmatic Engineer
...
### 6.28. Will AI Make Me Worse? — Wading Through AI, ep. 5
* <https://youtu.be/4fxo6zuhP1c>
 * AI is not a tool but a subordinate (lacks depth and preciseness, like Hulk and slow) — and a service you don't own, easily taken away, soon expensive

### 6.29. Lines of Code Got a Better Publicist — David Curlewis
* <https://curlewis.co.nz/posts/lines-of-code-got-a-better-publicist/>
 * Critique of LOC-style productivity metrics rebranded for the AI era
...
### 6.34. Code Isn't Free — Mario Zechner on the Hard Truths of Coding With AI
* <https://www.youtube.com/watch?v=GhjU-KvXtT0>
 * Mario Zechner (libGDX creator) on why AI-assisted coding accumulates hidden costs and complexity

### 6.35. Has AI Already Killed How-To Nonfiction? — Tim Ferriss
* <https://tim.blog/2026/06/12/has-ai-already-killed-nonfiction/>
 * Tim Ferriss uses his own book sales data to argue LLMs are killing prescriptive nonfiction — -46% in 2025, -57% run-rate in 2026
...
### 6.38. Making HTTP requests from a container that has no curl, using bash /dev/tcp
* <https://mareksuppa.com/til/bash-dev-tcp-http-without-curl/>
 * bash /dev/tcp trick for raw TCP sockets — HTTP without curl in stripped containers
...
### 6.43. Is Putin Losing His Grip on Russia? — Steve Rosenberg (The Rest Is Politics)
* <https://www.youtube.com/watch?v=a99U6aZ0i44>
 * Steve Rosenberg (BBC Russia editor) on war fatigue, Putin's evolution from reformer to Z-Russia, oligarchs, Trump disappointment, and Russia's technological decline

### 6.44. How The World Sees America, with Adam Tooze — The Ezra Klein Show
...
### 6.47. Announcing Silk — a silky smooth fiber runtime for ClickHouse
* <https://clickhouse.com/blog/silk>
 * Stackful-fiber scheduler with NUMA-aware work-stealing, io_uring I/O, and zero heap allocation in hot path — first target: ClickHouse distributed cache

### 6.48. The Cost YAGNI Was Never About — Kent Beck
* <https://newsletter.kentbeck.com/p/the-cost-yagni-was-never-about>
 * YAGNI reframed as two price-theory arguments: optionality (commitment forecloses futures) and NPV (pay late, receive early) — both survive free LLM code generation

### 6.49. Ian Bremmer on the Risks America Poses to the World — The Ezra Klein Show
* <https://www.youtube.com/watch?v=syl9OLNSm4k>
 * Bremmer on Trump as the dominant geopolitical risk — AI, China summit, Iran war, and whether US institutions can hold; connects to J-Curve thesis on openness vs stability
...
### 6.58. An Aristotelian Theory of Family — Goodsell & Whiting 2016
* <https://onlinelibrary.wiley.com/doi/10.1111/jftr.12169>
 * Paper applying Aristotelian theory to family studies: virtue, telos, phronesis, koinonia, narrative research as epistemological basis
...
### 6.61. Dear AI Companies: Stop the Doom Trolling — Cal Newport
* <https://calnewport.com/dear-ai-companies-stop-the-doom-trolling/>
 * Newport coins 'doom trolling': AI labs publishing existential-risk whitepapers while continuing to build — either stop or stop pretending. Morally indefensible either way.

### 6.62. I Keep Telling People We're Living in This Dystopian Novel — Ezra Klein & Gary Shteyngart
...
### 7.4. How To Master The Art Of Conversation (Using Psychology) — Dr. Thomas Fidyeman
* <https://www.youtube.com/watch?v=A25HHOtMp2U>
 * Dr. Thomas Fidyeman's bubble method (because, but, lately, for example) for more engaging self-disclosure in conversation
...
### 7.6. ThePrimeagen on Bun Zig to Rust Rewrite — a more positive take
* <https://www.youtube.com/watch?v=NgUNjjV_AkY>
 * Prime's take: it's fast, they have something to build on, pragmatic optimism vs Ray Myers' cynicism
...
### 7.9. @clickhouse/rowbinary — when your library is also a parser compiler
* <https://clickhouse.com/blog/clickhouse-rowbinary-library-parser-compiler>
 * Node.js RowBinary reader with SKILL.md agent layer that generates monomorphized parsers — 1.5–3.4x faster than generic dispatch, correct by construction
...
### 7.16. Is 'jobs' a four-letter word? — Benn Stancil
* <https://benn.substack.com/p/is-jobs-a-four-letter-word>
 * Benn Stancil on the cultural shift in Silicon Valley: from headcount-as-status to headlessness-as-status — the 1-person billion-dollar company dream, layoffs as marketing, and the uncomfortable question of what happens when 'giving jobs' stops being aspirational

### 7.17. What Causes Rejection (According to Psychology) — Dr. Thomas Mimman
* <https://www.youtube.com/watch?v=wL-UOhZrc40>
 * Three ejection systems: gut-level reaction (behavioral immune system), threat trigger (psychological reactance), compatibility filter (shared worldview + mutual investment) — clinical psychologist Dr. Mimman on the deep mechanisms of social rejection

### 7.18. Why AI Companies Need Scale — Wading Through AI (Dmitri Spanos)
* <https://www.youtube.com/watch?v=bgWq678Oed4>
 * Tyranny of scale: 7 axes forcing AI companies to grow (logarithmic scaling laws, data wall, user scale, CAPEX, too-big-to-fail, self-improving loop, legal scale) — same log curve as O(log n) but inverted: compute = O(2^quality)
...
### 7.22. Brute Intelligence — Benn Stancil
* <https://benn.substack.com/p/brute-intelligence>
 * AI as brute intelligence: verifiable-answer domains (math, software, drug dev) susceptible to agent loops; strategic move is turning problems into math problems

### 7.23. How Swimming Completely Changes The Human Body
* <https://www.youtube.com/watch?v=Xh0JNIpe-Vk>
 * Swimming's system-wide effects — brain BDNF, heart, lungs, joints, longevity data (2% vs 8-11% mortality).
...
### 8.5. Twenty years of blaming our customers — Yali Sassoon
* <https://datacreation.substack.com/p/twenty-years-of-blaming-our-customers>
 * AI proved 20yrs of "data adoption is a culture problem" wrong — it was the interface
...
### 8.8. How To Be Naturally Charismatic (Even If You're Quiet)
* <https://www.youtube.com/watch?v=oymPIpUlrd8>
 * Charisma as a spectrum — quiet charisma via subtle distinction, intentional silence, earned respect

### 8.9. Claude Is Not a Compiler — Josh Bleecher Snyder
* <https://blog.exe.dev/claude-is-not-a-compiler>
 * Vibe-coding vs vibe-engineering — using AI vertically across layers while retaining understanding

### 8.10. Aaron Sorkin on Why AI Will Fail, Facebook & The Future of America — What I've Learned, Esquire
* <https://www.youtube.com/watch?v=1Mu5RAfhECk>
 * Sorkin: optimistic about AI because he thinks it won't move us emotionally (painting anecdote); also on Facebook/Jan6, glamorization of dumbness, American institutions
...
### 8.16. The Road to SDN — ACM Queue
* <https://queue.acm.org/detail.cfm?id=2560327>
 * Intellectual history of Software Defined Networking (Feamster, Rexford, Zegura) — traces programmable network control planes from active networking through OpenFlow to SDN.

### 8.17. What New Jobs? — Wading Through AI, Episode 8
* <https://youtu.be/loaKh75eXM8>
...
### 8.19. Algorithms by Jeff Erickson
* <https://jeffe.cs.illinois.edu/teaching/algorithms/>
 * Free textbook/lecture notes on algorithm design and analysis (recurrences, complexity, graph algorithms) — relevant to complexity/shape-of-computation study.
...
### 9.9. Write Things Down — Ben Thompson
* <https://stratechery.com/2026/write-things-down/>
 * Writing things down (GTD, markdown harnesses, LLM context) is the scalable mechanism behind both human civilization and agentic AI progress; humans remain the subject who decides what gets written and acted on.
...
### 9.12. Anthropic Just Threatened to Kill Billions of People. This Is Not Okay. — Cal Newport
* <https://calnewport.com/anthropic-just-threatened-to-kill-billions-of-people-this-is-not-okay/>
 * Anthropic engineers publicly stating >10% extinction risk from their own work within a decade, resignations/pushback; Cal Newport pushes back on the fatalist rhetoric. Watching with interest, not deep-diving.

### 9.13. Every Millisecond Counts — Jordi Villar
* <https://jordivillar.com/blog/every-millisecond-counts>
 * Self-emailed link, unread — bookmarked for later.

### 9.14. High-Performance Database Architecture — Casey Muratori (Computer, Enhance!) w/ Tyler Cloutier, SpacetimeDB
* <https://www.computerenhance.com/p/spacetimedb>
 * ACID-style DB (SpacetimeDB) used for real-time game world state, vs conventional wisdom it's backend-only. For later deep-dive — kybel/ch-relevant.
