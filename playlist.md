...
- [JAN 2023](#jan-2023)
    - [GitHub Copilot preliminary experience report](#github-copilot-preliminary-experience-report)
    - [Free YouTube Transcripts](#free-youtube-transcripts)
    - [imaginAIry/README.md at master · brycedrennan/imaginAIry](#imaginairyreadmemd-at-master-·-brycedrennanimaginairy)
    - [Overconfidence and AI](#overconfidence-and-ai)
    - [Fighting Distraction With Unit Tests](#fighting-distraction-with-unit-tests)
    - [ChatGPT Is Only Going to Get Better, and We Better Get Used to It - Bloomberg](#chatgpt-is-only-going-to-get-better-and-we-better-get-used-to-it---bloomberg)
    - [Key Metrics for Monitoring AWS Fargate](#key-metrics-for-monitoring-aws-fargate)
    - [Amazon ECS container logs for EC2 and Fargate launch types - AWS Prescriptive Guidance](#amazon-ecs-container-logs-for-ec2-and-fargate-launch-types---aws-prescriptive-guidance)
    - [How to Profile Your Code in Python](#how-to-profile-your-code-in-python)
    - [ChatGPT's killer enterprise use case will be managing knowledge, says EY CTO](#chatgpts-killer-enterprise-use-case-will-be-managing-knowledge-says-ey-cto)
    - [The coming ubiquity - Seth's Blog](#the-coming-ubiquity---seths-blog)
    - [SQL should be your default choice for data engineering pipelines](#sql-should-be-your-default-choice-for-data-engineering-pipelines)
    - [dylanjcastillo/shell-genie: Your wishes are my commands](#dylanjcastilloshell-genie-your-wishes-are-my-commands)
    - [Natural language is the lazy user interface - Austin Z. Henley](#natural-language-is-the-lazy-user-interface---austin-z-henley)
    - [On Email and Horses - Study Hacks - Cal Newport](#on-email-and-horses---study-hacks---cal-newport)
    ...
    - [Yiren Lu on Twitter: I’ve been playing around with GPT for various use cases. Here are some low-hanging ones I haven’t heard people mention](#yiren-lu-on-twitter-ive-been-playing-around-with-gpt-for-various-use-cases-here-are-some-low-hanging-ones-i-havent-heard-people-mention)
    - [javascript - Timestamp of when request was submitted from client - Stack Overflow](#javascript---timestamp-of-when-request-was-submitted-from-client---stack-overflow)
- [FEB 2023](#feb-2023)
    - [Weaponizing hyperfocus: Becoming the first DevRel at Tailscale](#weaponizing-hyperfocus-becoming-the-first-devrel-at-tailscale)
...
####  If it helps, this likely is coming. I think we have a tendency to mentally mo
...
#### Where will the impact of ChatGPT fall? (from my email) - Marginal REVOLUTION
* <https://marginalrevolution.com/marginalrevolution/2023/02/where-will-the-impact-of-chatgpt-fall-from-my-email.html>
* An interesting new dimension on ChatGPT Enterprise
...
#### bash - How to access the metadata of a docker container from a script running inside the container? - Stack Overflow
